  ...
  return (
    <div className="bg-[#050505] min-h-screen text-white selection:bg-white/20">
      ...
      <motion.button 
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-8 left-8 z-[400] h-12 px-4 rounded-2xl glass border flex items-center gap-3 transition-colors duration-500 group shadow-2xl backdrop-blur-xl"
      >
